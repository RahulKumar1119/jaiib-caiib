...
export default function QuestionManagementPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Question Management</h1>
        <p className="text-gray-600 dark:text-gray-400">Manage JAIIB exam questions</p>
      </div>
